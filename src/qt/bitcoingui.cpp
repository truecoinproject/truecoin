    ...
    rpcConsole(0)
{
    ...
    setWindowTitle(tr("Truecoin") + " " + tr("Wallet"));
...
void BitcoinGUI::createActions()
{
    ...
    optionsAction->setToolTip(tr("Modify configuration options for Truecoin"));
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Truecoin address"));
    ...
    aboutAction->setToolTip(tr("Show information about Truecoin"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Truecoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Truecoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Truecoin network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Truecoin address or malformed URI parameters."));
    }
